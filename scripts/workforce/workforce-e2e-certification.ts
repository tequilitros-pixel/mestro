...
async function main() {
  ...
  const policyValues = {
    ...
    requireGeolocationClockIn: basePolicy.requireGeolocationClockIn,
    requireGeolocationClockOut: basePolicy.requireGeolocationClockOut,
    geofenceOutsideBehavior: basePolicy.geofenceOutsideBehavior,
    requireOutsideGeofenceReview: basePolicy.requireOutsideGeofenceReview,
    maximumGpsAccuracyMeters: basePolicy.maximumGpsAccuracyMeters,
