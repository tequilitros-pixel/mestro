...
const CACHE_NAME = IS_DEVELOPMENT_HOST ? "maestro-shell-dev-v10" : "maestro-shell-v10";
const STATIC_ASSETS = [
  "/manifest.json",
  "/icon-192.png",
  "/icon-512.png",
...
self.addEventListener("fetch", (event) => {
  ...
  if (url.pathname.startsWith("/_next/static/") || url.pathname.startsWith("/icons/") || url.pathname.match(/\.(?:png|webp|svg|woff2)$/)) {
    event.respondWith(
