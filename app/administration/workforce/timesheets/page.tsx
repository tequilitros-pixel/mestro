...
const parseWeek = (value?: string) =>
  value && /^\d{4}-\d{2}-\d{2}$/.test(value)
    ? mondayOf(parseDateOnly(value))
    : mondayOf(parseDateOnly(todayDateOnly()));
